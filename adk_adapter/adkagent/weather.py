...
def build_weather_agent(llm: BaseLlm) -> BaseAgent:
    base_agent = LlmAgent(
        name="weather",
        model=llm,
        instruction="""
...
if __name__ == "__main__":
    ...
    base_agent = build_weather_agent(llm)
    asyncio.run(adkrun.run_agent(base_agent, "What is the weather like in Shanghai?"))
